...
public class ConfigurationViewModel: ViewModelBase
    {
        ...
        public ObservableCollection<EndpointConfig> Endpoints { get; } = new ObservableCollection<EndpointConfig>();
        ...
        {
            Endpoints.Add(new EndpointConfig { Name = "OPC UA Server 1", Address = "opc.tcp://localhost:4840", Type = "OPC UA" });
            Endpoints.Add(new EndpointConfig { Name = "MQTT Broker", Address = "mqtt://broker.hivemq.com:1883", Type = "MQTT" });
        }
